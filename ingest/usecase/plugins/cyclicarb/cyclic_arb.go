...
func (o *cyclicArbPlugin) estimateCyclicArb(ctx blockctx.BlockCtxI, coinIn sdk.Coin, denomOut string, canonicalOrderbookPoolId uint64) (osmomath.Int, []domain.RoutablePool, error) {
...
func (o *cyclicArbPlugin) validateArb(ctx blockctx.BlockCtxI, amountIn osmomath.Int, denomIn, denomOut string, orderBookID uint64) (msgctx.MsgContextI, error) {
