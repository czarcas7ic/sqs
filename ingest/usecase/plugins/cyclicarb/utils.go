...
func (o *cyclicArbPlugin) usdcToDenomValueScaled(denomToValue string, desiredUSDCValue osmomath.Dec, prices domain.PricesResult) (osmomath.Int, error) {
...
func (o *cyclicArbPlugin) shouldSkipLowBalance(baseDenom string, baseAmountBalance osmomath.Int, prices domain.PricesResult) (bool, error) {
...
func (o *cyclicArbPlugin) validateUserBalances(ctx blockctx.BlockCtxI, baseDenom, quoteDenom string) error {
